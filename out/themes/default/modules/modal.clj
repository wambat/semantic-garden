(clojure.core/ns
 styles.themes.default.modules.modal
 (:require
...
(def contentBackground (clojure.core/str "#FFFFFF"))
(def imageWidth (clojure.core/str ""))
...
(def descriptionMinWidth (clojure.core/str ""))
