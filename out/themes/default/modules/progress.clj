(clojure.core/ns
 styles.themes.default.modules.progress
 (:require
...
(def barBackground (clojure.core/str "#888888"))
...
(def indicatingFirstColor (clojure.core/str "#D95C5C"))
(def indicatingSecondColor (clojure.core/str "#EFBC72"))
(def indicatingThirdColor (clojure.core/str "#E6BB48"))
(def indicatingFourthColor (clojure.core/str "#DDC928"))
(def indicatingFifthColor (clojure.core/str "#B4D95C"))
(def indicatingSixthColor (clojure.core/str "#66DA81"))
