...
(def element (clojure.core/str "statistic"))
(defstyles
 root
 [".ui.statistic"
 ...
 [".ui.five.statistics"
  [".statistic"
   {"min-width" (clojure.core/str fiveColumn),
    "margin" (clojure.core/str itemMargin)}]]
 [".ui.four.statistics"
  {"margin" (clojure.core/str itemGroupMargin)}]EXPR
(((:variableName @ itemGroupMargin)))
PROP
(:variableName @ itemGroupMargin)
EXPR
(((:variableName @ threeColumn)))
PROP
(:variableName @ threeColumn)
EXPR
(((:variableName @ itemMargin)))
PROP
(:variableName @ itemMargin)
EXPR
(((:variableName @ itemGroupMargin)))
...
(:identifier none)
EXPR
(((:variableName @ horizontalGroupElementMargin)))
PROP
(:variableName @ horizontalGroupElementMargin)
EXPR
(((:variableName @ iconWidth)))
PROP
(:variableName @ iconWidth)
EXPR
...
(:identifier middle)
EXPR
(((:measurement 0 em)) ((:measurement 0 em)) ((:measurement 0 em)) ((:variableName @ horizontalLabelDistance)))
PROP
(:measurement 0 em)
PROP
(:measurement 0 em)
...
(:measurement 0 em)
PROP
(:variableName @ horizontalLabelDistance)
EXPR
(((:variableName @ red)))
PROP
(:variableName @ red)
...
(:variableName @ grey)
EXPR
(((:variableName @ invertedValueColor)))
PROP
(:variableName @ invertedValueColor)
EXPR
