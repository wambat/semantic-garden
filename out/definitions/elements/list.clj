 ...
 [nil
  ["floated"
   {"float" (clojure.core/str "right"),
    "margin" (clojure.core/str rightFloatMargin)}]]EXPR
(((:identifier none)))
PROP
(:identifier none)
EXPR
...
(:identifier inline-block)
EXPR
(((:variableName @ horizontalSpacing)))
PROP
(:variableName @ horizontalSpacing)
EXPR
(((:measurement 1)) ((:identifier rem)))
PROP
(:measurement 1)
PROP
(:identifier rem)
...
(:measurement 0 em)
EXPR
(((:variableName @ horizontalVerticalAlign)))
PROP
(:variableName @ horizontalVerticalAlign)
EXPR
...
(:measurement 0 em)
EXPR
(((:measurement 0 em)) ((:variableName @ horizontalIconDistance)) ((:measurement 0 em)) ((:measurement 0 em)))
PROP
(:measurement 0 em)
PROP
(:variableName @ horizontalIconDistance)
PROP
(:measurement 0 em)
PROP
(:measurement 0 em)
...
(:identifier none)
EXPR
(((:variableName @ disabledColor) !important))
PROP
!important
EXPR
(((:variableName @ invertedDisabledColor) !important))
PROP
!important
EXPR
(((:variableName @ itemLinkIconHoverColor)))
PROP
(:variableName @ itemLinkIconHoverColor)
EXPR
(((:variableName @ invertedIconLinkColor)))
PROP
(:variableName @ invertedIconLinkColor)
EXPR
(((:variableName @ invertedHeaderColor)))
PROP
(:variableName @ invertedHeaderColor)
EXPR
(((:variableName @ invertedDescriptionColor)))
PROP
(:variableName @ invertedDescriptionColor)
EXPR
(((:identifier pointer)))
...
(:identifier pointer)
EXPR
(((:variableName @ invertedItemLinkColor)))
PROP
(:variableName @ invertedItemLinkColor)
EXPR
(((:variableName @ invertedItemLinkHoverColor)))
PROP
(:variableName @ invertedItemLinkHoverColor)
EXPR
(((:variableName @ invertedItemLinkColor) !important))
PROP
!important
EXPR
(((:variableName @ invertedItemLinkHoverColor) !important))
PROP
!important
EXPR
(((:identifier top) !important))
PROP
!important
EXPR
(((:identifier middle) !important))
PROP
!important
EXPR
(((:identifier bottom) !important))
PROP
!important
EXPR
(((:variableName @ linkListItemColor)))
PROP
(:variableName @ linkListItemColor)
EXPR
(((:variableName @ linkListTransition)))
PROP
(:variableName @ linkListTransition)
EXPR
(((:variableName @ linkListItemHoverColor)))
PROP
(:variableName @ linkListItemHoverColor)
EXPR
(((:variableName @ linkListItemDownColor)))
PROP
(:variableName @ linkListItemDownColor)
EXPR
(((:variableName @ linkListItemActiveColor)))
PROP
(:variableName @ linkListItemActiveColor)
EXPR
(((:variableName @ invertedLinkListItemColor)))
PROP
(:variableName @ invertedLinkListItemColor)
EXPR
(((:variableName @ invertedLinkListItemHoverColor)))
PROP
(:variableName @ invertedLinkListItemHoverColor)
EXPR
(((:variableName @ invertedLinkListItemDownColor)))
PROP
(:variableName @ invertedLinkListItemDownColor)
EXPR
(((:variableName @ invertedLinkListItemActiveColor)))
PROP
(:variableName @ invertedLinkListItemActiveColor)
