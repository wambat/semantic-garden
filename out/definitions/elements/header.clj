(clojure.core/ns
 styles.definitions.elements.header
 (:require
...
(defstyles
 ...
 [".ui.header"
  ["> img:only-child" {"margin-right" (clojure.core/str imageMargin)}]]
 [".ui.header"
  [".content"
   {"display" (clojure.core/str "inline-block"),
 ...
 ["h1.ui.header"
  [".sub.header" {"font-size" (clojure.core/str h1SubHeaderFontSize)}]]
 ["h2.ui.header"
  [".sub.header" {"font-size" (clojure.core/str h2SubHeaderFontSize)}]]
 ["h3.ui.header"
  [".sub.header" {"font-size" (clojure.core/str h3SubHeaderFontSize)}]]
 ["h4.ui.header"
  [".sub.header" {"font-size" (clojure.core/str h4SubHeaderFontSize)}]]
 ["h5.ui.header"
  [".sub.header" {"font-size" (clojure.core/str h5SubHeaderFontSize)}]]
 [".ui.huge.header"
 ...
 [".ui.sub.header" {"font-size" (clojure.core/str subHeadingFontSize)}]
 [".ui.large.sub.header"
 ...
 [".ui.icon.header.aligned"
  {"margin-left" (clojure.core/str "auto"),
   ...
   "display" (clojure.core/str "block")}]
 [".ui.disabled.header" {"opacity" (clojure.core/str disabledOpacity)}]
 ...
 [".ui.olive.dividing.header"
  {"border-bottom"
   (clojure.core/str dividedColoredBorderWidth " " "solid" " " olive)}]
 ...
 [".ui.green.dividing.header"
  {"border-bottom"
   (clojure.core/str dividedColoredBorderWidth " " "solid" " " green)}]
